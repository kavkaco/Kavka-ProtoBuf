...
/**
 * @generated from service message.v1.MessageService
 */
export const MessageService = {
  typeName: "message.v1.MessageService",
  methods: {
    /**
     * @generated from rpc message.v1.MessageService.FetchMessages
     */
    fetchMessages: {
      name: "FetchMessages",
    ...
    /**
     * @generated from rpc message.v1.MessageService.SendTextMessage
     */
    sendTextMessage: {
